...
class DashboardController extends AppController
{
	...
	public function get_weekly_attendance($user_id)
{
    // Obtener el inicio y fin de la semana actual
    $start_of_week = date('Y-m-d', strtotime('monday this week'));
    $end_of_week = date('Y-m-d', strtotime('sunday this week'));

    // Consultar asistencias en la tabla GymAttendance
    $attendance_table = TableRegistry::getTableLocator()->get('GymAttendance');
    return $attendance_table->find()
        ->where([
            'user_id' => $user_id,
            'attendance_date >=' => $start_of_week,
            'attendance_date <=' => $end_of_week,
            'status' => 'Present' // Contar solo asistencias válidas
        ])
        ->count();
}

public function get_monthly_attendance($user_id)
{
	...
	public function memberDashboard()
	{
		...
		// Calcular asistencias semanales y mensuales
		$weekly_attendance = $this->get_weekly_attendance($uid);
		$monthly_attendance = $this->get_monthly_attendance($uid);
		...
		$this->set("membership",$membership);
		$this->set("groups_data",$groups_data);
		$this->set("weekly_attendance", $weekly_attendance);
		$this->set("monthly_attendance", $monthly_attendance);
