...
<section class="content">
	...
	<div class="col-md-12 box box-default">
		...
		<?php
			...
			echo "<div class='form-group'>";
			echo '<label class="control-label col-md-2" for="email">'. __("Sucursal").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';
			echo $this->Form->select("branch_id", $branches, [
				"default" => ($edit) ? $data['branch_id'] : '',
				"empty" => __("Seleccione una sucursal"),
			...
			echo "<div class='form-group'>";
			echo '<label class="control-label col-md-2" for="email">'. __("Capacidad de alumnos").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';
			echo $this->Form->input("",["label"=>false,"name"=>"max_quota","type"=>"number","class"=>"form-control validate[required,custom[integer],min[1]]","value"=>(($edit)?$data['max_quota']:'')]);
			echo "</div>";
			echo "</div>";
