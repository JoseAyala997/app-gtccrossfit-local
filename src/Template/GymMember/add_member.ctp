...
// echo '<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-multiselect/0.9.16/css/bootstrap-multiselect.min.css" />';
// echo '<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-multiselect/0.9.16/js/bootstrap-multiselect.min.js"></script>';
...
<section class="content">
	...
	<div class="col-md-12 box box-default">		
		...
		<?php	
			...
			echo '<div class="form-group">';
			echo '<label class="control-label col-md-2" for="assigned_tags">' . __("Asignar Tag") . '</label>';
			echo '<div class="col-md-6">';

			echo $this->Form->select('assigned_tags', $tags, [
				'empty' => __('Seleccionar un Tag'),
				'class' => 'form-control',
				'id' => 'assigned_tags',
				'default' => ($edit && isset($data['member_tag'])) ? $data['member_tag']['id'] : ''
			]);
			...
			echo "<a href='{$this->request->base}/GymGroup/addGroup/' class='btn btn-flat btn-default'>".__("Group")."</a>";
			echo "</div>";	
			echo "</div>";
