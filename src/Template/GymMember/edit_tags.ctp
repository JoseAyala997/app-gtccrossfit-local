<section class="content">
    <div id="main-wrapper">
        <div class="col-md-12 box box-default">
            ...
            <hr>
            <div class="box-body">
                <?php echo $this->Form->create($tag, ["class" => "form-horizontal"]); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <?php echo $this->Form->control("color", ["type" => "color", "label" => false, "class" => "form-control"]); ?>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-4">
                        <?php echo $this->Form->button(__("Actualizar"), ["class" => "btn btn-primary"]); ?>
                    </div>
                </div>
