...
<ul class="sidebar-menu">
	...
	<!-- <li>
    <a href="<?= $this->Url->build(['controller' => 'PaymentConfirmation', 'action' => 'generatePayments']) ?>">
        <i class="fa fa-ticket"></i> <span><?= __('NUEVA FACTURA') ?></span>
    </a>
</li> -->
	<?php if ($this->request->session()->read('User.role_name') === 'administrator'): ?>
<!-- Para administradores, mostrar menú desplegable -->
<li class="treeview">
    <a href="#">
        <i class="fa fa-ticket"></i> <span><?= __('Créditos') ?></span>
    ...
    <ul class="treeview-menu">
        <li>
            <a href="<?= $this->Url->build(['controller' => 'GymMemberCredits', 'action' => 'holamundo']) ?>">
                <i class="fa fa-list"></i> <?= __('Gestionar Créditos') ?>
            </a>
        </li>
        <!-- Si necesitas más opciones, agrégalas aquí -->
    </ul>
</li>
<?php elseif ($this->request->session()->read('User.role_name') === 'member'): ?>
<!-- Para miembros, mostrar enlace directo -->
<li>
...
<?php endif; ?>
	...
	<li class="treeview <?php echo ($this->request->controller == "GymMember" || $this->request->controller == "StaffMembers" || $this->request->controller == "GymAccountant") ? "active" : ""; ?>">
		...
		<ul class="treeview-menu">
			...
			<li>
				<a href="<?php echo $this->Url->build(["controller"=>"GymMember","action"=>"maintenanceMode"]);?>">
					<i class="fa fa-plane"></i> <span><?php echo __("Modo Mantenimiento");?></span>
				</a>
			</li>
			...
			<li class="treeview <?php echo ($this->request->controller == "GymMember") ? "active" : "";?>">
              <a href="<?php echo $this->Gym->createurl("GymMember","viewMemberTags");?>">
                <i class="fa fa-tags"></i> <span><?php echo __("Tags");?></span>  
              </a>
			</li>
			...
			<li class="treeview <?php echo ($this->request->controller == "MembershipPayment") ? "active" : "";?>">
              <a href="<?php echo $this->Gym->createurl("MembershipPayment","paymentList");?>">
				...
				<ul class="treeview-menu">
					...
					<li class="<?php echo ($this->request->action == "paymentList" || $this->request->action == "generatePaymentInvoice" || $this->request->action == "membershipEdit") ? "active" : "";?>">
						<a href="<?php echo $this->Gym->createurl("PaymentConfirmation","index");?>">
						<i class="fa fa-circle-o"></i><span><?php echo __('Pendientes de confirmación');?></span>
						</a>
					</li>
					<li class="<?php echo ($this->request->controller == 'PaymentConfirmation' && $this->request->action == 'paymentHistory') ? 'active' : ''; ?>">
						<a href="<?php echo $this->Url->build(["controller" => "PaymentConfirmation", "action" => "paymentHistory"]); ?>">
							<i class="fa fa-history"></i> <span><?php echo __('Historial de Pagos'); ?></span>
						</a>
					</li>
	...
	<li class="treeview <?php echo ($this->request->controller == "GymAssignWorkout" || $this->request->controller == "GymDailyWorkout") ? "active" : ""; ?>">
		...
		<ul class="treeview-menu">
			...
			<li class="<?php echo ($this->request->action == "calendarioWorkout" || $this->request->action == "addWorkout" || $this->request->action == "addMeasurment" || $this->request->action == "viewWorkout" || $this->request->action == "editMeasurment") ? "active" : ""; ?>">
				<a href="<?php echo $this->Gym->createurl("GymDailyWorkout", "calendarioWorkout"); ?>">
					<i class="fa fa-circle-o"></i><span><?php echo __('Gym Calendar'); ?></span></i>
				</a>
			</li>
	...
	<?php if ($role_name == 'administrator') { ?>
		<li class="treeview <?php echo ($this->request->controller == "GymBranch") ? "active" : ""; ?>">
			<a href="<?php echo $this->Gym->createurl("GymBranch", "branchList"); ?>">
				<i class="fa fa-building"></i> <span><?php echo __("Sucursales"); ?></span>
			</a>
		</li>
