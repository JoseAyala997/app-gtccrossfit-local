...
<input type="hidden" id="get_language_ajax_path" value="<?php echo $this->Gym->createurl('GymAjax','getSystemLanguage');?>">
<script src="https://www.gstatic.com/charts/loader.js"></script>
<input type="hidden" id="getchartjs_path" value="<?php echo $this->Gym->createurl('GymAjax','getchartjs'); ?>">
		<?php
		$sys_lang = $this->Gym->getSettings("sys_language");
