<?php $session = $this->request->session(); ?>
          ...
          <ul class="sidebar-menu">
			...
			<li class="treeview <?php echo ($this->request->controller == "MembershipPayment" || $this->request->controller == "PaymentConfirmation")?"active":"";?>">
              <a href="javascript:void(0)">
                <i class="fa fa-money"></i> <span><?php echo __("Membership Payment");?></span>
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
              <ul class="treeview-menu">
                <li class="<?php echo ($this->request->controller == "MembershipPayment" && $this->request->action == "paymentList")?"active":"";?>">
                  <a href="<?php echo $this->Gym->createurl("MembershipPayment","paymentList");?>">
                    <i class="fa fa-circle-o"></i> <span><?php echo __("Payment List");?></span>
                  </a>
                </li>
                <li class="<?php echo ($this->request->controller == "MembershipPayment" && $this->request->action == "incomeList")?"active":"";?>">
                  <a href="<?php echo $this->Gym->createurl("MembershipPayment","incomeList");?>">
                    <i class="fa fa-circle-o"></i> <span><?php echo __("Income List");?></span>
                  </a>
                </li>
                <li class="<?php echo ($this->request->controller == "MembershipPayment" && $this->request->action == "expenseList")?"active":"";?>">
                  <a href="<?php echo $this->Gym->createurl("MembershipPayment","expenseList");?>">
                    <i class="fa fa-circle-o"></i> <span><?php echo __("Expense List");?></span>
                  </a>
                </li>
                <li class="<?php echo ($this->request->controller == "PaymentConfirmation" && $this->request->action == "index")?"active":"";?>">
                  <a href="<?php echo $this->Gym->createurl("PaymentConfirmation","index");?>">
                    <i class="fa fa-circle-o"></i> <span><?php echo __("Payment Confirmations");?></span>
                  </a>
                </li>
              </ul>
            </li>
