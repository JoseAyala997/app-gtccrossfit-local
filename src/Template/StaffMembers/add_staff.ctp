...
$(document).ready(function() {
	...
	$('#branch_ids').multiselect({
		includeSelectAllOption: true,
		nonSelectedText: "<?php echo __('Select Branches');?>",
		allSelectedText: "<?php echo __('All Branches Selected');?>",
		selectAllText : "<?php echo __('Select All');?>",	
	});
...
function validate_multiselect()
{
	...
	if(branch_ids == null)
	{
		alert( "<?php echo __('Select at least one branch.'); ?>" );
		return false;
	}
	return true;
}
...
<section class="content">
	...
	<div class="col-md-12 box box-default">
		...
		<div class="box-body">
			...
			echo "<div class='form-group'>";
			echo '<label class="control-label col-md-2" for="email">'. __("Branches").'<span class="text-danger"> *</span></label>';
			echo '<div class="col-md-6">';
			echo $this->Form->select("branch_ids",$branches,
				["multiple"=>"multiple",
				"class"=>"form-control",
				"id"=>"branch_ids",
				"default"=>($edit && isset($data['gym_branch'])) ? array_column($data['gym_branch'], 'id') : []
				]);
			echo "</div>";
			echo "</div>";
